...
describe('RadioOptionComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [TestComponent, RadioComponent, RadioOptionComponent, ConditionalContentDirective, FieldsetDirective, FieldsetHintDirective, LegendDirective, TextInputComponent],
    }).compileComponents();
  });
  ...
  it('should create', () => {
    expect(fixture.debugElement.queryAll(By.css('input[type="radio"]')).length).toEqual(2);
  });
